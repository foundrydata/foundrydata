const DIAGNOSTIC_CODE_VALUES = {
  ...
  REPAIR_TIER_DISABLED: 'REPAIR_TIER_DISABLED',
  REPAIR_REVERTED_NO_PROGRESS: 'REPAIR_REVERTED_NO_PROGRESS',
  REPAIR_GVALID_STRUCTURAL_ACTION: 'REPAIR_GVALID_STRUCTURAL_ACTION',
