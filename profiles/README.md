...
| `real-world/cityjson.schema.json` | https://raw.githubusercontent.com/cityjson/specs/master/schemas/cityjson.schema.json | CityJSON project (CC0 1.0). |
...
| --- | --- | --- | --- |
| `real-world/dense/cityjson.bundled.schema.json` | https://raw.githubusercontent.com/cityjson/specs/master/schemas/cityjson.schema.json | `npx tsx scripts/bundle-schema.ts profiles/real-world/cityjson.schema.json profiles/real-world/dense/cityjson.bundled.schema.json` | Includes `metadata`, `cityobjects`, `appearance`, `geomprimitives`, `geomtemplates` definitions. |
