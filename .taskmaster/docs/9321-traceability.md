...
- **9321.9321003 – Expand Known-Limits.md with coverage-aware limits**  
  Covers: [KR3], [KR4], [DEL3], [DOD3], [TS1]. Status: covered (Known-Limits.md now documents coverage-specific caps, AP:false coverage nuances, boundaries dimension constraints, dimensionsEnabled/excludeUnreachable semantics and operations scope semantics in line with the coverage-aware spec and implementation).
